...
const NewProds = () => {
    return ( 
        <section className="lg:h-[80vh] h-full grid lg:grid-cols-6 grid-cols-1 gap-6 justify-start items-start px-4 py-6 bg-secondary shadow">
            <div className="lg:col-span-2 col-span-6 bg-primary h-full rounded-md py-4">
                <div className="flex flex-col justify-start items-center gap-2">
                    <h1 className={`${bitter.className} text-xl font-extrabold drop-shadow-md text-neutral uppercase`}>The Wait is Over!</h1>
                    <h2 className={`${nunito.className} lg:text-4xl text-3xl font-bold drop-shadow-md text-cta`}>iPhone 16 Series</h2>
            ...
            <div className="flex flex-col justify-start items-start gap-4 lg:col-span-4 col-span-6">
                    <div className="w-full flex justify-between items-center">
                        <h1 className={`${nunito.className} text-3xl text-neutral font-bold`}>New Products</h1>
